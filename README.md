# Exploratory Data Analysis on Odom data in R
...
The spreadsheet DrivingdataAll.xls contains the data set from the experiment. I have analyzed the first four columns in R Studio and the data was proved to be fraudulent.
